        ...
        {data && <div className="highlights_info">
            ...
            <div className="highlights_inner">
                ...
                <div className="box_info">
                    ...
                    <div className="ssw">
                        <div className="icon-ssw"><FaWind/></div>
                        SSW
                        </div>
                </div>
                <div className="box_info">
                    <span className="type-info">Sunrise & Sunset</span>
                    <div className="sunrise icon"><span><FaArrowUp /></span>{(new Date(data.sunrise * 1000)).toLocaleString('en-US', { hour: 'numeric', minute: 'numeric', hour12: true })}</div>
                
                    <div className="sunset icon"><span><FaArrowDown/></span>{(new Date(data.sunset * 1000)).toLocaleString('en-US', { hour: 'numeric', minute: 'numeric', hour12: true })}</div>
                </div>
                <div className="box_info">
